...
var style_ProduccindePanelaToneladas_2 = function(feature, resolution){
    ...
    if (value >= 61.770000 && value <= 337.800000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 337.800000 && value <= 823.080000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 823.080000 && value <= 1925.470000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1925.470000 && value <= 3305.640000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3305.640000 && value <= 4864.360000) {
            style = [ new ol.style.Style({
